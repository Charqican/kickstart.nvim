...
--vim.keymap.set('n', '<S-Tab>', '<cmd>bprevious<CR>', { desc = 'Prev buffer', silent = true })
...
require('lazy').setup({
  ...
  --        config = function()'custom.userdefined.keymaps'
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      ...
      spec = {
        ...
        { '<leader>tt', desc = '[T]oggle [T]erminal', group = false },
